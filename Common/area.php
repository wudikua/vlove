...
class Province {
	...
	public static function getProvince() {
		...
		$rt = [];
		foreach ($data as $k=>$v) {
			$rt[$k] = $v['province_name'];
		}
		return $rt;
	}

	public static function getProvinceName($provinceId) {
		return ProvinceData::$data[$provinceId]['province_name'];
	}

	public static function getCity($provinceId) {
		$data = ProvinceData::$data;
		$rt = [];
		foreach ($data[$provinceId]['city'] as $k=>$v) {
			$rt[$k] = $v['city_name'];
		}
		return $rt;
	}
	...
	public static function getCityName($provinceId, $cityId) {
		return ProvinceData::$data[$provinceId]['city'][$cityId]['city_name'];
	}

	public static function getArea($provinceId, $cityId) {
		$data = ProvinceData::$data[$provinceId]['city'][$cityId]['area'];
		return $data;
	}

	public static function getAreaName($provinceId, $cityId, $areaId) {
		return ProvinceData::$data[$provinceId]['city'][$cityId]['area'][$areaId];
	}
...
$(function(){
	...
	$("#town_dist1").bind("change", function(){
		...
		if (town1_value == 0) {
			...
			url: window.regCity,
			cache: false,
			data: {provinceId:town1_value, r:get_rndnum(8)},
			dataType: "json",
...
$(function(){
	...
	$("#item_dist1").bind("change", function(){
		...
		if (dist1_value == 0) {
			...
			url: window.regCity,
			cache: false,
			data: {provinceId:dist1_value, r:get_rndnum(8)},
			dataType: "json",
			success: function(data) {
				//清空2，3级地区
				$("#item_dist2").empty();
	...
	$("#item_dist2").bind("change", function(){
		...
		if (dist2_value == 0) {
			...
			url: window.regArea,
			cache: false,
			data: {provinceId:dist1_value , cityId:dist2_value, r:get_rndnum(8)},
			dataType: "json",
			success: function(data) {
				//清空三级地区
				$("#item_dist3").empty();
