...
<div class="cp-bartitle">上传几张照片，增加您的魅力吧 <b id="up_tips">上传照片</b></div>
<div class="cp-layout-body">

	<form action="{:U('User/Photo/upload')}" method="post" enctype="multipart/form-data" name="upload_form" id="upload_form" target="uploadiframe" style="display:none;">
